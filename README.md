...
2. Add a function called `usd_rate` that looks up the most recent USD exchange rate for the provided `currency` parameter (defaults to `EUR`) via an exchangerate.host API call and returns the rate as a number
